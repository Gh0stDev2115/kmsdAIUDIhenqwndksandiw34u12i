...
// @version      1.1
// @description  Removes anti-adblock
// @author       Lemonaa
...
(function()
 {
    ...
    const observerr = new MutationObserver(checkYtIconExistence);

    observerr.observe(document.documentElement, {childList: true, subtree: true});
    ...
    if (debug) console.log("YT-Fuxer: Script started");
    ...
    function popupRemover() {
        ...
        setInterval(() => {
            ...
            if (popup) {
                if (debug) console.log("YT-Fuxer: Popup detected, removing...");
                ...
                if (debug) console.log("YT-Fuxer: Popup removed");
            }
    ...
    function unPauseVideo(video)
    {
        ...
        if (video.paused) {
            ...
            unpausedAfterSkip = 0;
            if (debug) console.log("YT-Fuxer: Unpaused video using 'k' key");
